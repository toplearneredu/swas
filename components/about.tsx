...
export default function About() {
  ...
  return (
    <section id="about" className="py-20 bg-gradient-to-br from-gray-800 via-emerald-900 to-gray-800">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl font-bold text-white mb-6">Where Society Calls, We Grow</h3>
          ...
          <div className="bg-gray-900/50 backdrop-blur-sm rounded-lg p-8 border border-emerald-500/20">
            ...
            <blockquote className="text-xl text-gray-300 text-center italic leading-relaxed mb-4">
              "Farmers till the soil. Children spark dreams. Women weave resilience. Volunteers are the hands that plant
              it all."
            </blockquote>
